...
public class UserValidation {
    ...
    public boolean validateFirstName(String fname) throws UserValidationException {
        return patternChecker(fname, NAME_PATTERN);
    }

    public boolean validateLastName(String lName) throws UserValidationException {
